...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20337664.svg)](https://doi.org/10.5281/zenodo.20337664)
...
A persistent, citable snapshot of this source tree is archived on Zenodo: [https://doi.org/10.5281/zenodo.20337664](https://doi.org/10.5281/zenodo.20337664) (concept DOI — always resolves to the latest release).
...
```bash
git clone https://github.com/HaTranThai/MedPrefix.git medprefix
cd medprefix
...
@software{medprefix_code_2026,
  ...
  year      = {2026},
  publisher = {Zenodo},
  doi       = {10.5281/zenodo.20337664},
  url       = {https://doi.org/10.5281/zenodo.20337664}
}
```
